...
public class Cube extends Solid {
    ...
    public Cube() {
        ...
        addIndices(4,5,6);
        addIndices(4,6,7);
        vertexBuffer.add(new Vertex(-1,-1,-1,new Col(0xff00ff), new Vec3D(-1,0,0), new Vec2D(0,0)));
        vertexBuffer.add(new Vertex(-1, 1,-1,new Col(0xffffff), new Vec3D(-1,0,0), new Vec2D(0,1)));
        vertexBuffer.add(new Vertex(-1, 1, 1,new Col(0xff00ff), new Vec3D(-1,0,0), new Vec2D(1,1)));
        ...
        vertexBuffer.add(new Vertex(-1,-1,-1,new Col(0xff00ff), new Vec3D(0,-1,0), new Vec2D(0,0)));
        vertexBuffer.add(new Vertex(-1,-1, 1,new Col(0xff00ff), new Vec3D(0,-1,0), new Vec2D(0,1)));
        vertexBuffer.add(new Vertex( 1,-1, 1,new Col(0xffffff), new Vec3D(0,-1,0), new Vec2D(1,1)));
        vertexBuffer.add(new Vertex( 1,-1,-1,new Col(0xffffff), new Vec3D(0,-1,0), new Vec2D(1,0)));
