...
public class Arrow extends Solid {
    ...
    public Arrow() {
        ...
        vertexBuffer.add(new Vertex(400, 330, 0.5, new Col(0xff0000))); // v2
        vertexBuffer.add(new Vertex(370, 300, 0.5, new Col(0x00ff00))); // v3
        vertexBuffer.add(new Vertex(400, 270, 0.5, new Col(0x0000ff))); // v4
